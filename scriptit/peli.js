document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById("naytto1").style.display = "block";
    document.getElementById("naytto2").style.display = "block";
    kaynnista_nappi.style.display = "block";
